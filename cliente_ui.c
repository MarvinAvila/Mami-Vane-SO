...
// ===============================
// FUNCIONES INTERACTIVAS - PACIENTES
// ===============================
...
// ===============================
// FUNCIONES INTERACTIVAS - MÉDICOS
// ===============================
...
// ===============================
// FUNCIONES INTERACTIVAS - MEDICAMENTOS
// ===============================
...
// ===============================
// FUNCIONES INTERACTIVAS - RECETAS
// ===============================
...
void procesar_submenu_pacientes() {
    ...
    do {
        ...
        switch(opcion) {
            case 1: crear_paciente_interactivo(); break;
            case 2: 
                enviar_comando("listar_pacientes");
                esperar_respuesta_formateada(5, "pacientes");
                break;
            case 3: buscar_paciente_interactivo(); break;
            case 4: actualizar_paciente_interactivo(); break;
            case 5: eliminar_paciente_interactivo(); break;
            case 0: printf("↩️  Volviendo al menú principal...\n"); break;
...
void procesar_submenu_medicos() {
    ...
    do {
        ...
        switch(opcion) {
            case 1: crear_medico_interactivo(); break;
            case 2: 
                enviar_comando("listar_medicos");
                esperar_respuesta_formateada(5, "medicos");
                break;
            case 3: buscar_medico_interactivo(); break;
            case 4: actualizar_medico_interactivo(); break;
            case 5: eliminar_medico_interactivo(); break;
            case 0: printf("↩️  Volviendo al menú principal...\n"); break;
            default: printf("❌ Opción no válida\n");
        }
...
void procesar_submenu_medicamentos() {
    ...
    do {
        ...
        switch(opcion) {
            case 1: crear_medicamento_interactivo(); break;
            case 2: 
                enviar_comando("listar_medicamentos");
                esperar_respuesta_formateada(5, "medicamentos");
                break;
            case 3: buscar_medicamento_interactivo(); break;
            case 4: actualizar_medicamento_interactivo(); break;
            case 5: eliminar_medicamento_interactivo(); break;
            case 0: printf("↩️  Volviendo al menú principal...\n"); break;
            default: printf("❌ Opción no válida\n");
        }
...
void procesar_submenu_recetas() {
    ...
    do {
        ...
        switch(opcion) {
            case 1: crear_receta_interactivo(); break;
            case 2: 
                enviar_comando("listar_recetas");
                esperar_respuesta_formateada(5, "recetas");
                break;
            case 3: buscar_receta_interactivo(); break;
            case 4: agregar_medicamento_receta_interactivo(); break;
            case 5: listar_medicamentos_receta_interactivo(); break;
            case 6: eliminar_receta_interactivo(); break;
            case 0: printf("↩️  Volviendo al menú principal...\n"); break;
            default: printf("❌ Opción no válida\n");
        }
